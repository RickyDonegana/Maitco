                    ...
                    <tr <?php echo $proyecto["id_proyecto"]; ?>" <?php if ($proyecto['estado'] == 'finalizado') { ?> style="display:none;" <?php } ?>>
                        ...
                        <td>
                            <form method="POST" class="select-container">
                                ...
                                <select data-action="cambiarEstado" class="select" data-id="<?php echo $proyecto['id_proyecto']; ?>" data-estado-actual="<?php echo $proyecto['estado']; ?>" data-tipo="proyecto">
                        ...
                        <td>
                            ...
                            <a href="../pages/editar_proyecto.php?id=<?php echo $proyecto["id_proyecto"]; ?>" data-action="editar" data-id="<?php echo $proyecto["id_proyecto"]; ?>" class="boton-editar"></a>
                            <button data-action="finalizar" data-id="<?php echo $proyecto["id_proyecto"]; ?>" data-tipo="proyecto" class="boton-finalizar">
