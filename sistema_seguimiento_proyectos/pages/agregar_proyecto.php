    ...
    <main class="contenedor-principal">
        ...
        <div class="formulario-proyecto">
            ...
            <form method="POST">
                ...
                <input type="text" class="input" name="nombre_proyecto" required>
                <label for="descripcion">Descripción:</label>
                <textarea class="input" name="descripcion" required></textarea>
                <label for="cliente">Cliente:</label>
                <input type="text" class="input" name="cliente" required>
                <label for="desarrollador">Desarrollador:</label>
                <input type="text" class="input" name="desarrollador" required>
                ...
                <input type="date" class="input" name="fecha_entrega_estimada" required>
