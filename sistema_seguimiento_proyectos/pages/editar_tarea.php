    ...
    <main class="contenedor-principal">
        ...
        <div class="formulario-tarea">
            ...
            <form method="POST">
                ...
                <input type="text" class="input" name="nombre_tarea" value="<?php echo $tarea['nombre_tarea']; ?>" required>
                <label for="descripcion_tarea" class="label">Descripción:</label>
                <textarea class="input" name="descripcion_tarea" rows="2" required><?php echo $tarea['descripcion_tarea']; ?></textarea>
                <label for="asignada_a" class="label">Asignada a:</label>
                <select name="asignada_a" class="input" required>
                    <?php
                ...
                <input type="date" class="input" name="fecha_vencimiento" value="<?php echo $tarea['fecha_vencimiento']; ?>" required>
                ...
                <input type="text" class="input" name="fecha_creacion" value="<?php echo $tarea['fecha_creacion']; ?>" readonly>
